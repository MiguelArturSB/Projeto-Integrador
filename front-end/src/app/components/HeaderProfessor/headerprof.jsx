...
/**
 * Header do portal do professor, com animação de logout, modal de perfil e modal de confirmação de logout.
 * Mostra informações do professor autenticado.
 */
