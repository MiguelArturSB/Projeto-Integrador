...
export default function HomeAluno() {
    ...
    const handleLogout = () => {
        ...
        toggleLogoutModal(); // Fecha o modal após o logout
                        ...
                        <div className="relative bg-white rounded-lg shadow-sm">
                            ...
                            <div className="p-4 md:p-5 text-center">
                                ...
                                <button 
                                    ...
                                    type="button" 
                                    className="text-white bg-blue-900 hover:bg-blue-950 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center cursor-pointer"
                                >
                                    Sim, sair
                                </button>
                                <button 
