                    ...
                    <form className="p-4 md:p-5" onSubmit={handleSubmit}>
                        <div className="grid gap-4 mb-4 grid-cols-2">
                            <div className="col-span-2">
                                ...
                                <div className='flex justify-center gap-3'>
                                    <input 
                                        ...
                                        required 
                                    />
                                    <button type="button" className='bg-blue-950 rounded-lg text-white hover:bg-blue-800 transition-all p-2 cursor-pointer'>Buscar</button>
                                </div>
                            </div>
                            ...
                            <div className="col-span-2">
                                ...
                                <input 
                                    type="password" // Alterado para 'password' para mascarar a senha
                                    name="senha" 
                                    id="senha" 
                                    value={senha}
                            ...
                            <div className="col-span-2 sm:col-span-1">
                                <label htmlFor="frequencia" className="block mb-2 text-sm font-medium text-gray-900">Frequência (%)</label>
                                <input 
                                    type="number" 
                                    name="frequencia" 
                                    id="frequencia" 
