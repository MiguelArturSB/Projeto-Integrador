                    ...
                    <form className="p-4 md:p-5" onSubmit={handleSubmit}>
                        <div className="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div className="col-span-2">
                                ...
                                <div className='bg-gray-100 border border-gray-200 text-gray-500 text-sm rounded-lg w-full p-2.5'>Fulano da Silva</div>
                            </div>
                            <div className="col-span-2 sm:col-span-1">
                                <label htmlFor="disciplina" className="block mb-2 text-sm font-medium text-gray-900">Disciplina</label>
                                <div className='bg-gray-100 border border-gray-200 text-gray-500 text-sm rounded-lg w-full p-2.5'>LER</div>
                            </div>
                            <div className="col-span-2 sm:col-span-1">
                                <label htmlFor="turma" className="block mb-2 text-sm font-medium text-gray-900">Turma</label>
                                <div className='bg-gray-100 border border-gray-200 text-gray-500 text-sm rounded-lg w-full p-2.5'>2MD</div>
                            </div>
                        </div>
                        <div className="mb-4">
